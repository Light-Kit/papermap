---
title: What does each foundation model cost to train?
date: '2026-04-08'
topics:
- scaling-laws
- foundation-model
summary: Training-cost estimates for the 11 anchor FMs — and the lanes a small lab can still credibly play in when training-from-scratch is off the menu.
