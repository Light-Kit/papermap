---
title: What is a foundation model — and how do we categorize them?
date: '2026-04-01'
topics:
- foundation-model
summary: Five-family taxonomy of biology FMs — single-cell, pathology, genomic, protein, multimodal — and the one-line definition that holds across them.
source: talks/fm-to-virtual-cells/what-is-a-foundation-model.md
---

> *Explainer page from the FM-to-Virtual-Cells talk corpus — see also the [state-of-play hub](foundation-models-state-of-play.md). Answers the question someone asks during Act 2 when you say "the five FM families."*
...
- **[Foundation models — state of play](foundation-models-state-of-play.md)** — the cross-family map this taxonomy sits inside.
- **[The model glossary](model-glossary.md)** — every FM named in the talk, one sentence each, grouped by family; the 11 anchor models link to the papermap blogs that cover them most fully.
