...
→ **Deeper:** [Stage 1 expanded — data corpus](stage-1-data-corpus.md).
...
→ **Deeper:** [Stage 2 expanded — tokenization](stage-2-tokenization.md).
...
→ **Deeper:** [Stage 3 expanded — architecture](stage-3-architecture.md).
...
→ **Deeper:** [Stage 4 expanded — pretraining objective](stage-4-pretraining-objective.md).
...
→ **Deeper:** [Stage 5 expanded — adaptation](stage-5-adaptation.md).
...
→ **Deeper:** [Stage 6 expanded — evaluation](stage-6-evaluation.md).
