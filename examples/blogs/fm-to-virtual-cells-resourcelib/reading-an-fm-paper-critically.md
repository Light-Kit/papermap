---
title: How to read a foundation-model paper critically
date: '2026-04-05'
topics:
- eval
- foundation-model
summary: Checklist that turns a 2026 reader from 'this model achieved 0.94 AUC' to 'did it actually clear the floor?' — reusable for any biology FM paper.
