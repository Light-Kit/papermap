...
3. **If you want to know where Bo Wang and the broader sc-FM camp are heading**, watch for **agentic wrappers** rather than larger checkpoints. X-Cell is the lead indicator, but [BioMap's VCHarness](https://www.biorxiv.org/) and Owkin's Claude integration sit in the same conceptual neighbourhood.
